...
AWS (EC2, Lambda, ECR, API Gateway, IAM, S3, SQS, SNS, RDS, RDS)
GCP (Cloud Storage, Pub/Sub)
Programming Languages;
Java, Rust, Javascript, Typescript, Python, COBOL
Other tech:
Spring, Spring Boot, CI/CD, Kafka, React.js, Angular, High Frequency Trading (HFT), Hydra Framework, Mongo, Sqlx, Dioxus, Leptos, Axum, Microservices, REST, Kubernetes, Docker, Git, Jenkins, Redis, PostgreSQL/MySQL
...
Education
MBA
PostGraduation in Web Development
...
💼 LinkedIn: [Connect with me](https://www.linkedin.com/in/flavio-pezzini) 
🐙 GitHub: [Check out my repositories](https://github.com/flaviopezzini)
